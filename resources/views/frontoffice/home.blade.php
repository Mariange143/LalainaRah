    ...
    @section('content')
        ...
        <section class="section1">
            <div data-aos="fade-right">
                <div class="paragraph1">
                    ...
                    <div class="picture1">
                        <img src="{{ asset('images/mode13.jpg') }}" alt="">
                    </div>
                </div>
            </div>
            <div class="paragraph2">
                <div class="para">
                    <div data-aos="fade-right">
                        <p>Séléctionner directement vos préférences en remplissant le champ ci-dessous.
                        </p>
                    </div>
                    <div class="picture2">
                ...
                <div class="champs_remplir">
                    ...
                    <div class="picture3">
                        <img src="{{ asset('images/back5.jpg') }}" alt="">
                    </div>
                </div>
        ...
        <section class="section2">
            ...
            <div class="organisateurs">
                <div class="slide_mpikarakara">
                    <div class="mpikarakara">
                        <div class="box1_slide">
                            ...
                            <p>Organisatrice d'événement depuis une dizaine d'année. Avant d'être organisatrice. Elle est passée de responsable salon de la mode avant d'arriver à cet étape.</p>
                            <div class="btn_plus">
                ...
                <div class="slide_mpikarakara">
                    <div class="mpikarakara">
                        <div class="box1_slide">
                            <h3>Retrouver <span>Stephano</span></h3>
                            <p>Organisateur d'événement depuis une dizaine d'année. Avant d'être organisateur. Il est passé de responsable salon de la mode avant d'arriver à cet étape.</p>
                            <div class="btn_plus">
                                <button class="voir_plus @if(!Auth::check()) please-log @endif">voir plus</button>
                            </div>
                        </div>
                ...
                <div class="forfait1">
                    ...
                    <div class="number2">
                        ...
                        <div class="orga_complete">
                            <i class="fa fa-check"> Planification globale</i><br><br>
                            <i class="fa fa-check"> Lieu & traiteur</i><br><br>
                            <i class="fa fa-check"> Décoration et ambiance</i><br><br>
                            <i class="fa fa-check"> Tenu des mariés </i><br></br>
                            <i class="fa fa-check"> Invitation papetérie </i>
                        </div>
                        <div class="btn_voir_plus1">
        ...
        <section class="section4">
            ...
            <p>Laissez les traces de votre réussite chez nous pour les autres.</p><br>
            <div class="section4_testimonials">
                <div class="testimonials">
                    <div class="slide">
                        ...
                        <div class="box2_slide">
                            <div class="picture5">
                                <img src="{{ asset('images/mode13.JPG') }}">
                            </div>
                        </div>
                        <div class="box1_slider">
                            ...
                            <h3>Hery & Sitraka</h3>
                            <p>Meilleurs des meilleurs services d'accompagnement événementiel que nous avons trouver nul part ailleur.  Nous vous en remercions infinement pour cette aide.
                                Buffet classe a sortue avec nos désirs! Service rapide est très satisfaisant, accueil très chaleureux. Vraiment CHAPEAU!!!.
                            </p>
                ...
                <div class="testimonials">
                    <div class="slide">
                        ...
                        <div class="box2_slide">
                            <div class="picture5">
                                <img src="{{ asset('images/temo3.jpg') }}">
                            </div>
                        </div>
                        <div class="box1_slider">
                            <span class="quatation_marks1">
                            ...
                            <h3>Mirana & Sarobidy</h3>
                            <p>Meilleurs des meilleurs services d'accompagnement événementiel que nous avons trouver nul part ailleur.  nous vous en remercions infinement pour cette aide.
                            Buffet classe a sortue avec nos désirs! Service rapide est très satisfaisant, accueil très chaleureux. BRAVOO!!!.</p>
                            <span class="quatation_marks2">
                                <i class="fa fa-quote-right"></i>
                            </span>
        ...
        <div class="devis">
            <div class="box1_devis">
                Besoins d'un <span>devis</span>
                <p>Vous pouvez nous consulter directement pour une demande devis pour une organisation</p>
                <div class="btn_devis">
                    <a href="./html/demande.php">
                        <button class="demande_devis">demande de devis</button>
                    </a>
                </div>
            </div>
            <div class="box2_slide">
                <div class="picture7">
                    ...
                    <div class="infos_devis">
                        <h4>Accompagnement avec des professionels</h4><br><br>
                        <p>Un seul formulaire pour chaque préstation</p>
                    </div>
                </div>
            </div>
        </div>
